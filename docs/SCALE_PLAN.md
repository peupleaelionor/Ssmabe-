...
## Palier 1M (vision)
- microservices voix (SFU dédiés par région), files Kafka/NATS
- données par région (RDC/UE/NA), résidence des données
- scoring fraude ML + modération assistée, équipe trust & safety
- apps natives + offline-first, CDN médias (R2/CloudFront)
- gouvernance : audit logs, conformité multi-juridictions
