...
export function Security() {
  return (
    <section id="security" className="scroll-mt-20 border-y border-or-doux/10 bg-vert-nuit/40 px-5 py-16 sm:py-24">
        ...
        <div className="mt-10 grid grid-cols-2 gap-3 sm:grid-cols-4 sm:gap-4">
          {RULES.map((r, i) => (
            <motion.div
              ...
              className="flex flex-col items-center gap-2.5 rounded-2xl border border-or-doux/20 bg-white/[0.035] px-3 py-6 text-center"
            >
