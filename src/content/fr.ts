...
export const fr = {
  ...
  vibes: {
    ...
    items: [
      { emoji: "💛", name: "Rencontre", text: "Parler à de vraies personnes — ex. un café vocal du soir — sans jamais exposer ton numéro." },
      { emoji: "🤝", name: "Amitié", text: "Recréer du lien : retrouver une présence, papoter après le travail, briser la solitude." },
      { emoji: "🌍", name: "Diaspora", text: "Garder le pont vivant : ex. un cercle « Kin-Paris » pour les nouvelles du pays." },
      { emoji: "📍", name: "Villes", text: "Ta ville en direct : Kinshasa, Goma, Lubumbashi, Paris, Bruxelles, Montréal." },
      { emoji: "💼", name: "Business", text: "Réseau local concret : commerces du quartier, petites annonces, services et opportunités." },
      { emoji: "🎤", name: "Créateurs", text: "Faire vivre ta voix : ex. un salon d'écoute pour artistes, podcasteurs et médias." },
      { emoji: "🏛", name: "Associations", text: "Organiser sans usine à gaz : familles, groupes étudiants, événements et entraide." },
      { emoji: "🕊", name: "Spiritualité", text: "Échanges respectueux et partage de valeurs : parole, guidance et transmission." },
    ],
  },
